...
YOUTUBE_BADGE_PATH = "https://badges.aleen42.com/src/youtube.svg"
...
class TableEntry:
    ...
    def from_csv_line(cls, csv_line: str) -> 'TableEntry':
        ...
        return TableEntry(
            notebook_name=csv_fields[0],
            roboflow_blogpost_path=csv_fields[1],
    ...
    def format(self) -> str:
        ...
        return f"| {notebook_link} | {roboflow_badge} |"
